...
export type BorderBeamResolvedTheme = 'dark' | 'light';

export interface ResolvedBorderBeamOptions {
  size: BorderBeamSize;
  colorVariant: BorderBeamColorVariant;
...
export interface CreateBorderBeamResult extends BorderBeamController {
